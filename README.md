...
## Docker
It is possible to run the java application through a docker container:

1. You may docker build and docker run or,
2. Simply with a single command "docker-compose run esaconsole" will set everything up.
