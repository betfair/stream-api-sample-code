...
namespace Betfair.ESASwagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarketDataFilter :  IEquatable<MarketDataFilter>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LadderLevels: ").Append(LadderLevels).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MarketDataFilter);
        }
        ...
        public bool Equals(MarketDataFilter other)
        {
            ...
            return 
                (
                    this.LadderLevels == other.LadderLevels ||
                    this.LadderLevels != null &&
                    this.LadderLevels.Equals(other.LadderLevels)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LadderLevels != null)
                    hash = hash * 59 + this.LadderLevels.GetHashCode();
